...
(async()=>{
  ...
  assert(shellSrc && /\?v=20260830-4$/.test(shellSrc),'10M page must cache-bust the GlobalShell asset');
  ...
  await browser.close();
  console.log('Language switcher shell placement + cache contract: PASS');
