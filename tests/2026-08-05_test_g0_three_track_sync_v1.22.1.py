...
VALIDATOR = ROOT / "tools/2026-08-05_validate_g0_three_track_sync_v1.22.1.py"


def main() -> None:
    spec = importlib.util.spec_from_file_location("g0_v1221_test", VALIDATOR)
    ...
    print("PASS: G0 v1.22.1 Background-3C11 regression tests")
