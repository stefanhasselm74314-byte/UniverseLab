...
VALIDATOR = ROOT / "tools/2026-08-05_validate_g0_three_track_sync_v1.21.py"


def main() -> None:
    spec = importlib.util.spec_from_file_location("g0_v121_test", VALIDATOR)
    ...
    assert result["candidate_sha256"] == module.CANDIDATE_DIGEST
    assert result["source_count"] == 24
    assert result["real_backend_control_status"] == module.R3_GATE
    ...
    print("PASS: G0 v1.21 Background-3C10 R3 regression tests")
