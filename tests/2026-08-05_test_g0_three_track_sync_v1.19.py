...
VALIDATOR = ROOT / "tools/2026-08-05_validate_g0_three_track_sync_v1.19.py"


def main() -> None:
    spec = importlib.util.spec_from_file_location("g0_v119_test", VALIDATOR)
    ...
    assert result["adapter_status"] == module.ADAPTER_STATUS
    ...
    print("PASS: G0 v1.19 Background-3C8 regression tests")
