#!/usr/bin/env python3
"""Regression tests for the UniverseLab G0 three-track synchronization."""
...
TOOL = ROOT / "tools" / "2026-08-03_validate_g0_three_track_sync_v1.0.py"

spec = importlib.util.spec_from_file_location("g0_three_track_validator", TOOL)
if spec is None or spec.loader is None:
    raise RuntimeError("unable to import G0 validator")
module = importlib.util.module_from_spec(spec)
sys.modules[spec.name] = module
spec.loader.exec_module(module)


class G0ThreeTrackTests(unittest.TestCase):
    @classmethod
    ...
    def test_validator_hash_is_stable(self) -> None:
        ...
        self.assertEqual(
            digest,
            "b89ced5a6ed58fb73cdc159f198143888c06c2670f2ff2e644239ebc753f6704",
        )
