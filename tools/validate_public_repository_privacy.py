...
The scanner is intentionally broader than the memory-protocol validator. It
covers public registries, governance, prompts, scientific documentation and
published HTML/JSON surfaces while excluding source files that contain the
scanner's own detection patterns.
"""
...
TEXT_SUFFIXES = {
    ".css", ".html", ".js", ".json", ".jsonl", ".md", ".txt", ".yaml", ".yml"
}
SCAN_ROOTS = (
    "registry",
    "governance",
...
def scan_text(path: str, text: str) -> list[Finding]:
    return [
        Finding("PRIVACY", path, f"forbidden pattern detected: {name}")
