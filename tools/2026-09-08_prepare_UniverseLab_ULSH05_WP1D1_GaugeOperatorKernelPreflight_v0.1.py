...
def main() -> None:
    ...
    print('global_domain_preflight:', d['gate_state']['WP1_global_domain_preflight'])
    print('physical_boundary_domain:', d['gate_state']['WP1_physical_boundary_domain'])
    print('full_global_boundary_hessian:', d['gate_state']['WP1_full_global_boundary_hessian'])
