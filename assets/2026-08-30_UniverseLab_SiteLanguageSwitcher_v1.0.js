...
function injectStyle(){if(document.getElementById('ul-language-style'))return;const s=document.createElement('style');s.id='ul-language-style';s.textContent='.ul-shell__language{display:inline-flex;align-items:center;gap:6px;min-height:36px;padding:3px 6px;border:1px solid #6657b8;border-radius:10px;background:#13162b;color:#fff}.ul-shell__language-icon{font-size:16px;line-height:1}.ul-shell__language select{min-height:30px;max-width:150px;border:0;outline:0;background:transparent;color:#fff;font:800 12px/1.2 system-ui,-apple-system,"Segoe UI",sans-serif}.ul-shell__language option{background:#101522;color:#fff}@media(max-width:480px){.ul-shell__language{order:99;min-height:38px;padding:4px 7px}.ul-shell__language select{max-width:132px;font-size:12px}}';(document.head||document.documentElement).appendChild(s)}
