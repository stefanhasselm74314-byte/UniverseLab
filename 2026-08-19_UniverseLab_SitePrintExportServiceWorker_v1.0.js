 ...
 * v1.0.4: loads the machine-data-viewer-aware navigation utility.
 */
'use strict';
...
self.addEventListener('fetch',event=>{
  ...
  event.respondWith((async()=>{
    ...
    const injection='<script '+MARK+'="1" src="'+TOOL+'" defer></script><!-- UniverseLab SitePrintExport SW v1.0.4 -->';
